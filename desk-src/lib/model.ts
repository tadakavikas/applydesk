import { SKILLS, extractSkills, matchesJobQuery } from "../../shared/job-search.mjs";
export { SKILLS, extractSkills, matchesJobQuery };
  ...
  return j.sponsorship === "h1b"
    ...
    : j.sponsorship === "visa"
      ...
      : j.sponsorship === "not_sponsored"
        ...
        : j.evidence ? "Sponsorship restrictions stated" : "Sponsorship not stated";
}
